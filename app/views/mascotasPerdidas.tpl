    ...
    <div class="row margin-out">
        <div class="col s12 m6 l3 xl2 margin-in pointer" ng-repeat="perdida in mascotasPerdidas.perdidas | limitTo: 12" ng-class="{'offset-m1': $first || ($index == 6) }">
            <div class="center-align">
                <div class="circle foto-mascota" style="background-image:url({{mascotasPerdidas.apiDir.dominio}}{{mascotasPerdidas.apiDir.path}}{{mascotasPerdidas.apiDir.imagenes.mascotas}}{{perdida.foto}}); background-position: 100% 100%; background-size: cover;">
                </div>
