            ...
            <div class="col s11 offset-s1 m4 offset-m1">
                ...
                <div class="input-formulario">
                    <div ng-class="{'margin-bottom-30': formPaso1.nombreMascota.$pristine || formPaso1.nombreMascota.$valid}">
                        <input ng-model="misMascotasNueva.datos.nombre" ng-class="{'valido': formPaso1.nombreMascota.$valid, 'erroneo': (!formPaso1.nombreMascota.$valid && formPaso1.nombreMascota.$dirty)}" placeholder="Nombre de tu mascota " type="text" name="nombreMascota" minlength="3" required>
            ...
            <div class="col s11 offset-s1 m4 offset-m1">
                ...
                <div class="input-formulario">
                    <div ng-class="{'margin-bottom-30': formPaso1.generoMasccota.$pristine || formPaso1.generoMasccota.$valid}">
                        <md-select ng-model="misMascotasNueva.datos.genero" ng-class="{'valido': formPaso1.generoMasccota.$valid, 'erroneo': (!formPaso1.generoMasccota.$valid && formPaso1.generoMasccota.$dirty)}" placeholder="Genero" class="md-no-underline" name="generoMasccota" required>
            ...
            <div class="col s11 offset-s1 m4 offset-m1">
                ...
                <div class="input-formulario">
                    <div ng-class="{'margin-bottom-30': formPaso1.especie.$pristine || formPaso1.especie.$valid}">
                        <md-select ng-change="misMascotasNueva.cargarRazas(misMascotasNueva.datos.especie)" ng-model="misMascotasNueva.datos.especie" ng-class="{'valido': formPaso1.especie.$valid, 'erroneo': (!formPaso1.especie.$valid && formPaso1.especie.$dirty)}" placeholder="Especie" name="especie" class="md-no-underline" required>
                            <md-option ng-repeat="especie in misMascotasNueva.especies" value="{{especie.idEspecie}}">{{especie.especie}}</md-option>
                        </md-select>
            ...
            <div class="col s11 offset-s1 m4 offset-m2">
                ...
                <div class="input-formulario">
                    <div ng-class="{'margin-bottom-30': formPaso1.raza.$pristine || formPaso1.raza.$valid}">
                        <md-select ng-model="misMascotasNueva.datos.razas_idRaza" ng-class="{'valido': formPaso1.raza.$valid, 'erroneo': (!formPaso1.raza.$valid && formPaso1.raza.$dirty)}" placeholder="Raza" name="raza" class="md-no-underline" required>
                            <md-option ng-repeat="raza in misMascotasNueva.razas" value="{{raza.idRaza}}">{{raza.raza}}</md-option>
                        </md-select>
        ...
        <div class="row">
            <div class="col s11 offset-s1 m11 offset-m1">
                <div class="margin-bottom-30">
                    ...
                    <div class="input-formulario">
                        <textarea ng-model="misMascotasNueva.datos.comentarios" placeholder="Comentarios" rows="3"></textarea>
                    </div>
                </div>
            </div>
            <div class="row">
