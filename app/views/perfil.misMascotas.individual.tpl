<div class="row">
    <div class="col s12 center-align"> Nombre </div>
</div>
...
<div class="row">
    <div class="col s12 center-align"> IMAGEN </div>
</div>
...
<div class="row">
    <div class="col s12 center-align">Corbatas</div>
</div>

<!---- INFORMACION BASICA ---->

<div class="row">
    <div class="col s10 offset-s1">Información básica</div>
</div>
...
<div class="row">
    <div class="col s10 offset-s1">
        ...
        <div class="contenido-info">Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum</div>
        <div class="divider"></div>
    </div>
</div>
...
<div class="row">
    <div class="col s10 offset-s1">Información médica</div>
</div>
...
<div class="row">
    ...
    <div class="col s4 offset-s2">
        ...
        <div class="row fechas-vacunas">
            <div class="col s4">Parbovirosis</div>
            <div class="col s4">12-03-2017</div>
            <div class="col s4">RADIO</div>
        </div>
        <div class="row fechas-vacunas">
            <div class="col s4">Rabia</div>
            <div class="col s4">12-03-2017</div>
            <div class="col s4">RADIO</div>
        </div>
    </div>
...
<div class="row">
    <div class="col s10 offset-s1">Información de mi(s) dueño(s)</div>
</div>
