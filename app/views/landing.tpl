...
<section class="nuestras-placas">
    <div class="row">
        <div class="col s10 offset-s1 m10 offset-m1 center-align">
            <p class="semibold titulo1">Con nuestras placas indentificativas inteligentes podrás recuperar a tu mascota de forma rápida y sencilla, además de actualizar tu información todas las veces que quieras</p>
        </div>
    </div>
</section>
                ...
                <div class="card-panel">
                    <div class="row">
                        <div class="col s12 m4 margin-in">
                            <div class="center-align"><img class="responsive-img" src="assets/images/icons/crea_un_perfil.png"></div>
                            <div class="negrita center-align titulo2 interlineado20">1. Compra una Placa QR</div>
                        ...
                        <div class="col s12 m4 margin-in">
                            ...
                            <div class="negrita center-align titulo2 interlineado20">3. Activa tu placa QR</div>
